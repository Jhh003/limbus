...
export class GlobalRankingController {
  ...
  createRankingCard(record, rank) {
    ...
    const date = new Date(record.submittedAt).toLocaleDateString('zh-CN');
      ...
      <div class="ranking-card ${rankClass}" data-record-id="${record._id}">
        ...
        <div class="ranking-content">
          ...
          <div class="completion-info">
            <div class="floor-badge">第${record.floorLevel}层</div>
  ...
  handleFilterClick(e) {
    ...
    if (filterType === 'sinner') {
      this.filters.sinner = this.filters.sinner === filterValue ? null : filterValue;
    } else if (filterType === 'floor') {
      this.filters.floorLevel = this.filters.floorLevel == filterValue ? null : filterValue;
    }
    ...
    if (this.filters[filterType === 'sinner' ? 'sinner' : 'floorLevel']) {
